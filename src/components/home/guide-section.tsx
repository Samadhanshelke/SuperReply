        ...
        <>
            <div className="relative flex items-center snap-y snap-mandatory justify-center md:mb-0 mb-5">
                <div className="custom-scrollbar snap-y scroll-smooth snap-mandatory flex md:flex-col items-center justify-around gap-6 mx-2 overflow-x-scroll overflow-y-auto md:h-[80vh] md:mb-10 md:block md:w-[100%] md:overflow-x-auto md:overflow-y-scroll">
                    ...
                    <GuideStep stepNum={"1 :"} stepName={"Comment"} imageOffset={"-translate-x-4"} imageOffsetMobile={"-translate-x-3"} width={370} height={330} image={Feature1} description={"Encourage user comments on your posts & significantly increase your content's reach. More comments, More reach, More automated conversations."} />
                    </div>
                    <div className="snap-center">
                    ...
                    <div className="snap-center">
                    <GuideStep stepNum={"3 :"} stepName={"Sales Conversion"} imageOffset={"translate-x-7"} imageOffsetMobile={"translate-x-3 "}  width={180} height={300} image={Feature3} description={"Convert the intent automatically into sales by offering incentives and building urgency in the DM chat. "} />
                    </div>
                </div>
            </div>
        </>
